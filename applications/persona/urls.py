...
#  asignamos un argumento <shorname>
...
urlpatterns = [
    ...
    path('lista-by-trabajo/<jobemp>', views.ListByTrabajoEmpleado.as_view()),
    path('buscar-empleado/', views.ListEmpleadosByKword.as_view()),
    path('lista-habilidades-empleado/', views.ListHabilidadesEmpleado.as_view()),
    # <pk> hace referencia a un id interno a recuperar,  tambien se recupera con el nombre del modelo <empleado>
